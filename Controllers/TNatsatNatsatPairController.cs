...
namespace TwoDPro3.Controllers
{
    ...
    public class TNatsatNatsatPairController : Controller
    {
        private readonly CalendarContext _context;

        public TNatsatNatsatPairController(CalendarContext context)
        {
            _context = context;
        }
        ...
        // ==================================================
        // ALL DAY TNATSAT – NATSAT
        // GET api/TNatsatNatsatPair/alldaytnatsatnatsatpair
        // ==================================================
        [HttpGet("alldaytnatsatnatsatpair")]
        public async Task<ActionResult<List<List<Calendar>>>> SearchAllDays(string tnatsatnatsatpair)
        {
            if (tnatsatnatsatpair != "tnatsatnatsatpair")
                return BadRequest("Parameter must be 'tnatsatnatsatpair'.");
        ...
        // ==================================================
        // WEEK SETS TNATSAT – NATSAT
        // GET api/TNatsatNatsatPair/weeksetstnatsatnatsatpair
        // ==================================================
        [HttpGet("weeksetstnatsatnatsatpair")]
        public async Task<ActionResult<List<List<Calendar>>>> SearchWeekSets(
            string tnatsatnatsatpair, string day)
        {
            if (tnatsatnatsatpair != "tnatsatnatsatpair")
                return BadRequest("Parameter must be 'tnatsatnatsatpair'.");
