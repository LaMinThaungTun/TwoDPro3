...
namespace TwoDPro3.Controllers
{
    ...
    public class DgOneOneBrotherPairController : Controller
    {
        private readonly CalendarContext _context;

        public DgOneOneBrotherPairController(CalendarContext context)
        {
            _context = context;
        }
        ...
        // ================= ALL DAYS =================
        [HttpGet("alldaydgoneonebrotherpair")]
        public async Task<ActionResult<List<List<Calendar>>>> SearchAllDays(string dgoneonebrotherpair)
        {
            if (dgoneonebrotherpair != "dgoneonebrotherpair")
                return BadRequest("Parameter must be 'dgoneonebrotherpair'.");
            ...
            var foundRows = await _context.Table1
                .Where(c =>
                    ...
                    (
                        (c.AmDgOne == "0" && c.PmDgOne == "1") || (c.AmDgOne == "1" && c.PmDgOne == "0") ||
                        (c.AmDgOne == "1" && c.PmDgOne == "2") || (c.AmDgOne == "2" && c.PmDgOne == "1") ||
                        (c.AmDgOne == "2" && c.PmDgOne == "3") || (c.AmDgOne == "3" && c.PmDgOne == "2") ||
                        (c.AmDgOne == "3" && c.PmDgOne == "4") || (c.AmDgOne == "4" && c.PmDgOne == "3") ||
                        (c.AmDgOne == "4" && c.PmDgOne == "5") || (c.AmDgOne == "5" && c.PmDgOne == "4") ||
                        (c.AmDgOne == "5" && c.PmDgOne == "6") || (c.AmDgOne == "6" && c.PmDgOne == "5") ||
                        (c.AmDgOne == "6" && c.PmDgOne == "7") || (c.AmDgOne == "7" && c.PmDgOne == "6") ||
                        (c.AmDgOne == "7" && c.PmDgOne == "8") || (c.AmDgOne == "8" && c.PmDgOne == "7") ||
                        (c.AmDgOne == "8" && c.PmDgOne == "9") || (c.AmDgOne == "9" && c.PmDgOne == "8") ||
                        (c.AmDgOne == "9" && c.PmDgOne == "0") || (c.AmDgOne == "0" && c.PmDgOne == "9")
                    ) &&
            ...
            if (!foundRows.Any())
                return NotFound("No matching DG One–One brother pairs found.");
        ...
        // ================= WEEK SETS =================
        [HttpGet("weeksetsdgoneonebrotherpair")]
        public async Task<ActionResult<List<List<Calendar>>>> SearchWeekSets(string dgoneonebrotherpair, string day)
        {
            if (dgoneonebrotherpair != "dgoneonebrotherpair")
                return BadRequest("Parameter must be 'dgoneonebrotherpair'.");
