...
namespace TwoDPro3.Controllers
{
    ...
    public class DgTwoTwoPairController : Controller
    {
        private readonly CalendarContext _context;

        public DgTwoTwoPairController(CalendarContext context)
        {
            _context = context;
        }
        ...
        // ==========================================================
        // 1) ALL DAYS SEARCH
        // GET api/DgTwoTwoPair/alldaydgtwotwopair?number=1&number2=2
        // ==========================================================
        [HttpGet("alldaydgtwotwopair")]
            ...
            string number, string number2)
        {
            ...
            if (!foundRows.Any())
                return NotFound("No matching DG Two–Two pair found.");
        ...
        // ==========================================================
        // 2) WEEKSETS SEARCH
        // GET api/DgTwoTwoPair/weeksetsdgtwotwopair?number=1&number2=2&day=Monday
        // ==========================================================
        [HttpGet("weeksetsdgtwotwopair")]
