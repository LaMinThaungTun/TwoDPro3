...
namespace TwoDPro3.Controllers
{
    ...
    public class DgOneTwoPairController : Controller
    {
        private readonly CalendarContext _context;

        public DgOneTwoPairController(CalendarContext context)
        {
            _context = context;
        }
        ...
        // ==========================================================
        // 1) ALL DAYS SEARCH
        // GET api/DgOneTwoPair/alldaydgonetwopair?number=1&number2=2
        // ==========================================================
        [HttpGet("alldaydgonetwopair")]
            ...
            string number, string number2)
        {
            ...
            if (!foundRows.Any())
                return NotFound("No matching DG One–Two pair found.");
        ...
        // ==========================================================
        // 2) WEEKSETS SEARCH
        // GET api/DgOneTwoPair/weeksetsdgonetwopair?number=1&number2=2&day=Monday
        // ==========================================================
        [HttpGet("weeksetsdgonetwopair")]
