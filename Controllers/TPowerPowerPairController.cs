...
namespace TwoDPro3.Controllers
{
    ...
    public class TPowerPowerPairController : Controller
    {
        private readonly CalendarContext _context;

        public TPowerPowerPairController(CalendarContext context)
        {
            _context = context;
        }
        ...
        // ==================================================
        // ALL DAY T POWER – POWER
        // GET api/TPowerPowerPair/alldaytpowerpowerpair
        // ==================================================
        [HttpGet("alldaytpowerpowerpair")]
        public async Task<ActionResult<List<List<Calendar>>>> SearchAllDays(string tpowerpowerpair)
        {
            if (tpowerpowerpair != "tpowerpowerpair")
                return BadRequest("Parameter must be 'tpowerpowerpair'.");
        ...
        // ==================================================
        // WEEK SETS T POWER – POWER
        // GET api/TPowerPowerPair/weeksetstpowerpowerpair
        // ==================================================
        [HttpGet("weeksetstpowerpowerpair")]
        public async Task<ActionResult<List<List<Calendar>>>> SearchWeekSets(
            string tpowerpowerpair, string day)
        {
            if (tpowerpowerpair != "tpowerpowerpair")
                return BadRequest("Parameter must be 'tpowerpowerpair'.");
