...
public class PadetharTensPairController : Controller
{
    private readonly CalendarContext _context;

    public PadetharTensPairController(CalendarContext context)
    {
        _context = context;
    }
    ...
    // ================= ALL DAYS =================
    [HttpGet("alldaypadethartenspair")]
    public async Task<ActionResult<List<List<Calendar>>>> SearchAllDays(string padethartenspair)
    {
        if (padethartenspair != "padethartenspair")
            return BadRequest();
