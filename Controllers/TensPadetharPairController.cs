...
public class TensPadetharPairController : Controller
{
    private readonly CalendarContext _context;

    public TensPadetharPairController(CalendarContext context)
    {
        _context = context;
    }
    ...
    // ================= ALL DAYS =================
    [HttpGet("alldaytenspadetharpair")]
    public async Task<ActionResult<List<List<Calendar>>>> SearchAllDays(string tenspadetharpair)
    {
        if (tenspadetharpair != "tenspadetharpair")
            return BadRequest();
