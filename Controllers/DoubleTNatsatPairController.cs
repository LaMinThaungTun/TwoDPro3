...
namespace TwoDPro3.Controllers
{
    ...
    public class DoubleTNatsatPairController : Controller
    {
        private readonly CalendarContext _context;

        public DoubleTNatsatPairController(CalendarContext context)
        {
            _context = context;
        }

        // ==========================
        // DOUBLE & TNATSAT NUMBERS
        // ==========================
        ...
        // ==========================================================
        // 1) ALL DAY DOUBLE–TNATSAT PAIR
        // GET api/DoubleTNatsatPair/alldaydoublenatsatpair?doublenatsatpair=doublenatsatpair
        // ==========================================================
        [HttpGet("alldaydoubletnatsatpair")]
        public async Task<ActionResult<List<List<Calendar>>>> SearchAllDays(string doubletnatsatpair)
        {
            if (doubletnatsatpair != "doubletnatsatpair")
                return BadRequest("Parameter must be 'doublenatsatpair'.");
            ...
            if (!foundRows.Any())
                return NotFound("No double tnatsat pairs found.");
        ...
        // ==========================================================
        // 2) WEEK SETS DOUBLE–TNATSAT PAIR
        // GET api/DoubleTNatsatPair/weeksetsdoublenatsatpair?doublenatsatpair=doublenatsatpair&day=Monday
        // ==========================================================
        [HttpGet("weeksetsdoublenatsatpair")]
        public async Task<ActionResult<List<List<Calendar>>>> SearchWeekSets(string doubletnatsatpair, string day)
        {
            if (doubletnatsatpair != "doubletnatsatpair")
                return BadRequest("Parameter must be 'doubletnatsatpair'.");
