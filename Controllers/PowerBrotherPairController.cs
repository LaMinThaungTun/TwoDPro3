...
namespace TwoDPro3.Controllers
{
    ...
    public class PowerBrotherPairController : Controller
    {
        private readonly CalendarContext _context;

        public PowerBrotherPairController(CalendarContext context)
        {
            _context = context;
        }

        // ==========================
        // POWER & BROTHER NUMBERS
        // ==========================
        ...
        // ==========================================================
        // 1) ALL DAY POWER–BROTHER PAIR
        // GET api/PowerBrotherPair/alldaypowerbrotherpair?powerbrotherpair=powerbrotherpair
        // ==========================================================
        [HttpGet("alldaypowerbrotherpair")]
        public async Task<ActionResult<List<List<Calendar>>>> SearchAllDays(string powerbrotherpair)
        {
            if (powerbrotherpair != "powerbrotherpair")
                return BadRequest("Parameter must be 'powerbrotherpair'.");
            ...
            if (!foundRows.Any())
                return NotFound("No power brother pairs found.");
        ...
        // ==========================================================
        // 2) WEEK SETS POWER–BROTHER PAIR
        // GET api/PowerBrotherPair/weeksetspowerbrotherpair?powerbrotherpair=powerbrotherpair&day=Monday
        // ==========================================================
        [HttpGet("weeksetspowerbrotherpair")]
        public async Task<ActionResult<List<List<Calendar>>>> SearchWeekSets(string powerbrotherpair, string day)
        {
            if (powerbrotherpair != "powerbrotherpair")
                return BadRequest("Parameter must be 'powerbrotherpair'.");
