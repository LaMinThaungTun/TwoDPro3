...
namespace TwoDPro3.Controllers
{
    ...
    public class PadetharDoublePairController : Controller
    {
        private readonly CalendarContext _context;

        public PadetharDoublePairController(CalendarContext context)
        {
            _context = context;
        }
        ...
        // ==================================================
        // ALL DAYS
        // GET api/PadetharDoublePair/alldaypadethardoublepair?padethardoublepair=padethardoublepair
        // ==================================================
        [HttpGet("alldaypadethardoublepair")]
        public async Task<ActionResult<List<List<Calendar>>>> SearchAllDays(string padethardoublepair)
        {
            if (padethardoublepair != "padethardoublepair")
                return BadRequest("Parameter must be 'padethardoublepair'.");
            ...
            if (!foundRows.Any())
                return NotFound("No padethar-double pairs found.");
        ...
        // ==================================================
        // WEEK SETS
        // GET api/PadetharDoublePair/weeksetspadethardoublepair?padethardoublepair=padethardoublepair&day=Monday
        // ==================================================
        [HttpGet("weeksetspadethardoublepair")]
        public async Task<ActionResult<List<List<Calendar>>>> SearchWeekSets(string padethardoublepair, string day)
        {
            if (padethardoublepair != "padethardoublepair")
                return BadRequest("Parameter must be 'padethardoublepair'.");
