...
namespace TwoDPro3.Controllers
{
    ...
    public class PowerTNatsatPairController : Controller
    {
        private readonly CalendarContext _context;

        public PowerTNatsatPairController(CalendarContext context)
        {
            _context = context;
        }
        ...
        // ==================================================
        // ALL DAY POWER–T NATSAT
        // GET api/PowerTNatsatPair/alldaypowertnatsatpair
        // ==================================================
        [HttpGet("alldaypowertnatsatpair")]
        public async Task<ActionResult<List<List<Calendar>>>> SearchAllDays(string powertnatsatpair)
        {
            if (powertnatsatpair != "powertnatsatpair")
                return BadRequest("Parameter must be 'powertnatsatpair'.");
        ...
        // ==================================================
        // WEEK SETS POWER–T NATSAT
        // GET api/PowerTNatsatPair/weeksetspowertnatsatpair
        // ==================================================
        [HttpGet("weeksetspowertnatsatpair")]
        public async Task<ActionResult<List<List<Calendar>>>> SearchWeekSets(
            string powertnatsatpair, string day)
        {
            if (powertnatsatpair != "powertnatsatpair")
                return BadRequest("Parameter must be 'powertnatsatpair'.");
