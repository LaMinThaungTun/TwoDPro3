...
public class TPowerPadetharPairController : Controller
{
    private readonly CalendarContext _context;

    public TPowerPadetharPairController(CalendarContext context)
    {
        _context = context;
    }
    ...
    // ================= ALL DAYS =================
    [HttpGet("alldaytpowerpadetharpair")]
    public async Task<ActionResult<List<List<Calendar>>>> SearchAllDays(string tpowerpadetharpair)
    {
        if (tpowerpadetharpair != "tpowerpadetharpair")
            return BadRequest();
