...
public class PadetharTPowerPairController : Controller
{
    private readonly CalendarContext _context;

    public PadetharTPowerPairController(CalendarContext context)
    {
        _context = context;
    }
    ...
    // ================= ALL DAYS =================
    [HttpGet("alldaypadethartpowerpair")]
    public async Task<ActionResult<List<List<Calendar>>>> SearchAllDays(string padethartpowerpair)
    {
        if (padethartpowerpair != "padethartpowerpair")
            return BadRequest();
