...
public class TensBrotherPairController : Controller
{
    private readonly CalendarContext _context;

    public TensBrotherPairController(CalendarContext context)
    {
        _context = context;
    }
    ...
    // ================= ALL DAYS =================
    [HttpGet("alldaytensbrotherpair")]
    public async Task<ActionResult<List<List<Calendar>>>> SearchAllDays(string tensbrotherpair)
    {
        if (tensbrotherpair != "tensbrotherpair")
            return BadRequest();
