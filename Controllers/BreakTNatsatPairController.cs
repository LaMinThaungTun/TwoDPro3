...
namespace TwoDPro3.Controllers
{
    ...
    public class BreakTNatsatPairController : Controller
    {
        private readonly CalendarContext _context;

        public BreakTNatsatPairController(CalendarContext context)
        {
            _context = context;
        }
        ...
        // ================= ALL DAYS =================
        [HttpGet("alldaybreaktnatsatpair")]
        public async Task<ActionResult<List<List<Calendar>>>> SearchAllDays(string breaktnatsatpair)
        {
            if (breaktnatsatpair != "breaktnatsatpair")
                return BadRequest("Parameter must be 'breaktnatsatpair'.");
            ...
            var foundRows = await _context.Table1
                .Where(c =>
                    ...
                    (
                        ...
                        (c.AmBreak == "1" && c.PmBreak == "9") || (c.AmBreak == "9" && c.PmBreak == "1") ||
                        (c.AmBreak == "2" && c.PmBreak == "3") || (c.AmBreak == "3" && c.PmBreak == "2") ||
                        (c.AmBreak == "4" && c.PmBreak == "8") || (c.AmBreak == "8" && c.PmBreak == "4") ||
            ...
            if (!foundRows.Any())
                return NotFound("No matching break TNatsat pairs found.");
        ...
        // ================= WEEK SETS =================
        [HttpGet("weeksetsbreaktnatsatpair")]
        public async Task<ActionResult<List<List<Calendar>>>> SearchWeekSets(string breaktnatsatpair, string day)
        {
            if (breaktnatsatpair != "breaktnatsatpair")
                return BadRequest("Parameter must be 'breaktnatsatpair'.");
