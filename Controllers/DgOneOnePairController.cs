...
namespace TwoDPro3.Controllers
{
    ...
    public class DgOneOnePairController : Controller
    {
        private readonly CalendarContext _context;

        public DgOneOnePairController(CalendarContext context)
        {
            _context = context;
        }
        ...
        // ==========================================================
        // 1) ALL DAYS SEARCH
        // GET api/DgOneOnePair/alldaydgoneonepair?number=1&number2=2
        // ==========================================================
        [HttpGet("alldaydgoneonepair")]
            ...
            string number, string number2)
        {
            ...
            if (!foundRows.Any())
                return NotFound("No matching DG One–One pair found.");
        ...
        // ==========================================================
        // 2) WEEKSETS SEARCH
        // GET api/DgOneOnePair/weeksetsdgoneonepair?number=1&number2=2&day=Monday
        // ==========================================================
        [HttpGet("weeksetsdgoneonepair")]
