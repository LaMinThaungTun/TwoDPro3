...
public class TNatsatPadetharPairController : Controller
{
    private readonly CalendarContext _context;

    public TNatsatPadetharPairController(CalendarContext context)
    {
        _context = context;
    }
    ...
    // ================= ALL DAYS =================
    [HttpGet("alldaytnatsatpadetharpair")]
    public async Task<ActionResult<List<List<Calendar>>>> SearchAllDays(string tnatsatpadetharpair)
    {
        if (tnatsatpadetharpair != "tnatsatpadetharpair")
            return BadRequest();
