...
namespace TwoDPro3.Controllers
{
    ...
    public class BrotherDoublePairController : Controller
    {
        private readonly CalendarContext _context;

        public BrotherDoublePairController(CalendarContext context)
        {
            _context = context;
        }

        // ==========================
        // BROTHER & DOUBLE NUMBERS
        // ==========================
        ...
        // ==========================================================
        // 1) ALL DAY BROTHER–DOUBLE PAIR
        // GET api/BrotherDoublePair/alldaybrotherdoublepair?brotherdoublepair=brotherdoublepair
        // ==========================================================
        [HttpGet("alldaybrotherdoublepair")]
        public async Task<ActionResult<List<List<Calendar>>>> SearchAllDays(string brotherdoublepair)
        {
            if (brotherdoublepair != "brotherdoublepair")
                return BadRequest("Parameter must be 'brotherdoublepair'.");
            ...
            if (!foundRows.Any())
                return NotFound("No brother double pairs found.");
        ...
        // ==========================================================
        // 2) WEEK SETS BROTHER–DOUBLE PAIR
        // GET api/BrotherDoublePair/weeksetsbrotherdoublepair?brotherdoublepair=brotherdoublepair&day=Monday
        // ==========================================================
        [HttpGet("weeksetsbrotherdoublepair")]
        public async Task<ActionResult<List<List<Calendar>>>> SearchWeekSets(string brotherdoublepair, string day)
        {
            if (brotherdoublepair != "brotherdoublepair")
                return BadRequest("Parameter must be 'brotherdoublepair'.");
