...
namespace TwoDPro3.Controllers
{
    ...
    public class DoublePowerPairController : Controller
    {
        private readonly CalendarContext _context;

        public DoublePowerPairController(CalendarContext context)
        {
            _context = context;
        }
        ...
        // ==========================================================
        // 1) ALL DAY DOUBLE–POWER PAIR
        // GET api/DoublePowerPair/alldaydoublepowerpair?doublepowerpair=doublepowerpair
        // ==========================================================
        [HttpGet("alldaydoublepowerpair")]
        public async Task<ActionResult<List<List<Calendar>>>> SearchAllDays(string doublepowerpair)
        {
            if (doublepowerpair != "doublepowerpair")
                return BadRequest("Parameter must be 'doublepowerpair'.");
            ...
            if (!foundRows.Any())
                return NotFound("No double power pairs found.");
        ...
        // ==========================================================
        // 2) WEEK SETS DOUBLE–POWER PAIR
        // GET api/DoublePowerPair/weeksetsdoublepowerpair?doublepowerpair=doublepowerpair&day=Monday
        // ==========================================================
        [HttpGet("weeksetsdoublepowerpair")]
        public async Task<ActionResult<List<List<Calendar>>>> SearchWeekSets(string doublepowerpair, string day)
        {
            if (doublepowerpair != "doublepowerpair")
                return BadRequest("Parameter must be 'doublepowerpair'.");
