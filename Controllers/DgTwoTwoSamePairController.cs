...
namespace TwoDPro3.Controllers
{
    ...
    public class DgTwoTwoSamePairController : Controller
    {
        private readonly CalendarContext _context;

        public DgTwoTwoSamePairController(CalendarContext context)
        {
            _context = context;
        }
        ...
        // ==========================================================
        // 1) ALL DAYS DG TWO–TWO SAME PAIR
        // GET api/DgTwoTwoSamePair/alldaydgtwotwosamepair?dgtwotwosamepair=dgtwotwosamepair
        // ==========================================================
        [HttpGet("alldaydgtwotwosamepair")]
        public async Task<ActionResult<List<List<Calendar>>>> SearchAllDays(string dgtwotwosamepair)
        {
            if (dgtwotwosamepair != "dgtwotwosamepair")
                return BadRequest("Parameter must be 'dgtwotwosamepair'.");
            ...
            if (!foundRows.Any())
                return NotFound("No valid DG Two–Two same pairs found.");
        ...
        // ==========================================================
        // 2) WEEK SETS DG TWO–TWO SAME PAIR
        // GET api/DgTwoTwoSamePair/weeksetsdgtwotwosamepair?dgtwotwosamepair=dgtwotwosamepair&day=Monday
        // ==========================================================
        [HttpGet("weeksetsdgtwotwosamepair")]
        public async Task<ActionResult<List<List<Calendar>>>> SearchWeekSets(
            string dgtwotwosamepair, string day)
        {
            if (dgtwotwosamepair != "dgtwotwosamepair")
                return BadRequest("Parameter must be 'dgtwotwosamepair'.");
