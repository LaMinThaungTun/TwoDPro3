...
namespace TwoDPro3.Controllers
{
    ...
    public class TPowerBrotherPairController : Controller
    {
        private readonly CalendarContext _context;

        public TPowerBrotherPairController(CalendarContext context)
        {
            _context = context;
        }
        ...
        // ==================================================
        // ALL DAY TPOWER–BROTHER
        // GET api/TPowerBrotherPair/alldaytpowerbrotherpair
        // ==================================================
        [HttpGet("alldaytpowerbrotherpair")]
        public async Task<ActionResult<List<List<Calendar>>>> SearchAllDays(string tpowerbrotherpair)
        {
            if (tpowerbrotherpair != "tpowerbrotherpair")
                return BadRequest("Parameter must be 'tpowerbrotherpair'.");
        ...
        // ==================================================
        // WEEK SETS TPOWER–BROTHER
        // GET api/TPowerBrotherPair/weeksetstpowerbrotherpair
        // ==================================================
        [HttpGet("weeksetstpowerbrotherpair")]
        public async Task<ActionResult<List<List<Calendar>>>> SearchWeekSets(
            string tpowerbrotherpair, string day)
        {
            if (tpowerbrotherpair != "tpowerbrotherpair")
                return BadRequest("Parameter must be 'tpowerbrotherpair'.");
