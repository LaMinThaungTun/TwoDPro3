...
namespace TwoDPro3.Controllers
{
    ...
    public class BrotherPowerPairController : Controller
    {
        private readonly CalendarContext _context;

        public BrotherPowerPairController(CalendarContext context)
        {
            _context = context;
        }

        // ==========================
        // BROTHER & POWER NUMBERS
        // ==========================
        ...
        // ==========================================================
        // 1) ALL DAY BROTHER–POWER PAIR
        // GET api/BrotherPowerPair/alldaybrotherpowerpair?brotherpowerpair=brotherpowerpair
        // ==========================================================
        [HttpGet("alldaybrotherpowerpair")]
        public async Task<ActionResult<List<List<Calendar>>>> SearchAllDays(string brotherpowerpair)
        {
            if (brotherpowerpair != "brotherpowerpair")
                return BadRequest("Parameter must be 'brotherpowerpair'.");
            ...
            if (!foundRows.Any())
                return NotFound("No brother power pairs found.");
        ...
        // ==========================================================
        // 2) WEEK SETS BROTHER–POWER PAIR
        // GET api/BrotherPowerPair/weeksetsbrotherpowerpair?brotherpowerpair=brotherpowerpair&day=Monday
        // ==========================================================
        [HttpGet("weeksetsbrotherpowerpair")]
        public async Task<ActionResult<List<List<Calendar>>>> SearchWeekSets(string brotherpowerpair, string day)
        {
            if (brotherpowerpair != "brotherpowerpair")
                return BadRequest("Parameter must be 'brotherpowerpair'.");
