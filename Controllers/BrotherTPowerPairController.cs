...
namespace TwoDPro3.Controllers
{
    ...
    public class BrotherTPowerPairController : Controller
    {
        private readonly CalendarContext _context;

        public BrotherTPowerPairController(CalendarContext context)
        {
            _context = context;
        }
        ...
        // ==================================================
        // ALL DAY BROTHER–TPOWER
        // GET api/BrotherTPowerPair/alldaybrothertpowerpair
        // ==================================================
        [HttpGet("alldaybrothertpowerpair")]
        public async Task<ActionResult<List<List<Calendar>>>> SearchAllDays(string brothertpowerpair)
        {
            if (brothertpowerpair != "brothertpowerpair")
                return BadRequest("Parameter must be 'brothertpowerpair'.");
        ...
        // ==================================================
        // WEEK SETS BROTHER–TPOWER
        // GET api/BrotherTPowerPair/weeksetsbrothertpowerpair
        // ==================================================
        [HttpGet("weeksetsbrothertpowerpair")]
        public async Task<ActionResult<List<List<Calendar>>>> SearchWeekSets(
            string brothertpowerpair, string day)
        {
            if (brothertpowerpair != "brothertpowerpair")
                return BadRequest("Parameter must be 'brothertpowerpair'.");
