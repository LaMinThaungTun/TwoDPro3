...
namespace TwoDPro3.Controllers
{
    ...
    public class DgTwoOneSamePair2Controller : Controller
    {
        private readonly CalendarContext _context;
        public DgTwoOneSamePair2Controller(CalendarContext context)
        {
            _context = context;
        }
        ...
        // ==========================================================
        // 1) ALL DAYS DIGIT TWO ONE SAME PAIR SEARCH
        // GET api/SameNumberPair/alldaydgtwoonesamepair?dgtwoonesamepair=dgtwoonesamepair
        // ==========================================================
        [HttpGet("alldaydgtwoonesamepair")]
        public async Task<ActionResult<List<List<Calendar>>>> SearchAllDays(string dgtwoonesamepair)
        {
            if (dgtwoonesamepair != "dgtwoonesamepair")
                return BadRequest("Parameter must be 'dgtwoonesamepair'.");
        ...
        // ==========================================================
        // 2) WEEK SETS  TWO ONE SAME PAIR SEARCH
        // GET api/SameNumberPair/weeksetsdgtwoonesamepair?dgtwoonesamepair=dgtwoonesamepair&day=Monday
        // ==========================================================
        [HttpGet("weeksetsdgtwoonesamepair")]
        public async Task<ActionResult<List<List<Calendar>>>> SearchWeekSets(
            string dgtwoonesamepair, string day)
        {
            if (dgtwoonesamepair != "dgtwoonesamepair")
                return BadRequest("Parameter must be 'dgtwoonesamepair'.");
