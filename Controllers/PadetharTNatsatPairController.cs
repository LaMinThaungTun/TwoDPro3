...
public class PadetharTNatsatPairController : Controller
{
    private readonly CalendarContext _context;

    public PadetharTNatsatPairController(CalendarContext context)
    {
        _context = context;
    }
    ...
    // ================= ALL DAYS =================
    [HttpGet("alldaypadethartnatsatpair")]
    public async Task<ActionResult<List<List<Calendar>>>> SearchAllDays(string padethartnatsatpair)
    {
        if (padethartnatsatpair != "padethartnatsatpair")
            return BadRequest();
