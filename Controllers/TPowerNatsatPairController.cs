...
namespace TwoDPro3.Controllers
{
    ...
    public class TPowerNatsatPairController : Controller
    {
        private readonly CalendarContext _context;

        public TPowerNatsatPairController(CalendarContext context)
        {
            _context = context;
        }
        ...
        // ==================================================
        // ALL DAY T POWER – NATSAT
        // GET api/TPowerNatsatPair/alldaytpowernatsatpair
        // ==================================================
        [HttpGet("alldaytpowernatsatpair")]
        public async Task<ActionResult<List<List<Calendar>>>> SearchAllDays(string tpowernatsatpair)
        {
            if (tpowernatsatpair != "tpowernatsatpair")
                return BadRequest("Parameter must be 'tpowernatsatpair'.");
        ...
        // ==================================================
        // WEEK SETS T POWER – NATSAT
        // GET api/TPowerNatsatPair/weeksetstpowernatsatpair
        // ==================================================
        [HttpGet("weeksetstpowernatsatpair")]
        public async Task<ActionResult<List<List<Calendar>>>> SearchWeekSets(
            string tpowernatsatpair, string day)
        {
            if (tpowernatsatpair != "tpowernatsatpair")
                return BadRequest("Parameter must be 'tpowernatsatpair'.");
