...
namespace TwoDPro3.Controllers
{
    ...
    public class TNatsatBrotherPairController : Controller
    {
        private readonly CalendarContext _context;

        public TNatsatBrotherPairController(CalendarContext context)
        {
            _context = context;
        }
        ...
        // ==================================================
        // ALL DAY TNATSAT–BROTHER
        // GET api/TNatsatBrotherPair/alldaytnatsatbrotherpair
        // ==================================================
        [HttpGet("alldaytnatsatbrotherpair")]
        public async Task<ActionResult<List<List<Calendar>>>> SearchAllDays(string tnatsatbrotherpair)
        {
            if (tnatsatbrotherpair != "tnatsatbrotherpair")
                return BadRequest("Parameter must be 'tnatsatbrotherpair'.");
        ...
        // ==================================================
        // WEEK SETS TNATSAT–BROTHER
        // GET api/TNatsatBrotherPair/weeksetstnatsatbrotherpair
        // ==================================================
        [HttpGet("weeksetstnatsatbrotherpair")]
        public async Task<ActionResult<List<List<Calendar>>>> SearchWeekSets(
            string tnatsatbrotherpair, string day)
        {
            if (tnatsatbrotherpair != "tnatsatbrotherpair")
                return BadRequest("Parameter must be 'tnatsatbrotherpair'.");
