...
namespace TwoDPro3.Controllers
{
    ...
    public class DoubleTPowerPairController : Controller
    {
        private readonly CalendarContext _context;

        public DoubleTPowerPairController(CalendarContext context)
        {
            _context = context;
        }

        // ==========================
        // DOUBLE & TPOWER NUMBERS
        // ==========================
        ...
        // ==========================================================
        // 1) ALL DAY DOUBLE–TPOWER PAIR
        // GET api/DoubleTPowerPair/alldaydoubletpowerpair?doubletpowerpair=doubletpowerpair
        // ==========================================================
        [HttpGet("alldaydoubletpowerpair")]
        public async Task<ActionResult<List<List<Calendar>>>> SearchAllDays(string doubletpowerpair)
        {
            if (doubletpowerpair != "doubletpowerpair")
                return BadRequest("Parameter must be 'doubletpowerpair'.");
            ...
            if (!foundRows.Any())
                return NotFound("No double tpower pairs found.");
        ...
        // ==========================================================
        // 2) WEEK SETS DOUBLE–TPOWER PAIR
        // GET api/DoubleTPowerPair/weeksetsdoubletpowerpair?doubletpowerpair=doubletpowerpair&day=Monday
        // ==========================================================
        [HttpGet("weeksetsdoubletpowerpair")]
        public async Task<ActionResult<List<List<Calendar>>>> SearchWeekSets(string doubletpowerpair, string day)
        {
            if (doubletpowerpair != "doubletpowerpair")
                return BadRequest("Parameter must be 'doubletpowerpair'.");
