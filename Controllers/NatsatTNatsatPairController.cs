...
namespace TwoDPro3.Controllers
{
    ...
    public class NatsatTNatsatPairController : Controller
    {
        private readonly CalendarContext _context;

        public NatsatTNatsatPairController(CalendarContext context)
        {
            _context = context;
        }
        ...
        // ==================================================
        // ALL DAY NATSAT – TNATSAT
        // GET api/NatsatTNatsatPair/alldaynatsattnatsatpair
        // ==================================================
        [HttpGet("alldaynatsattnatsatpair")]
        public async Task<ActionResult<List<List<Calendar>>>> SearchAllDays(string natsattnatsatpair)
        {
            if (natsattnatsatpair != "natsattnatsatpair")
                return BadRequest("Parameter must be 'natsattnatsatpair'.");
        ...
        // ==================================================
        // WEEK SETS NATSAT – TNATSAT
        // GET api/NatsatTNatsatPair/weeksetsnatsattnatsatpair
        // ==================================================
        [HttpGet("weeksetsnatsattnatsatpair")]
        public async Task<ActionResult<List<List<Calendar>>>> SearchWeekSets(
            string natsattnatsatpair, string day)
        {
            if (natsattnatsatpair != "natsattnatsatpair")
                return BadRequest("Parameter must be 'natsattnatsatpair'.");
