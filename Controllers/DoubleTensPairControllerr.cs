...
namespace TwoDPro3.Controllers
{
    ...
    public class DoubleTensPairController : Controller
    {
        private readonly CalendarContext _context;

        public DoubleTensPairController(CalendarContext context)
        {
            _context = context;
        }
        ...
        // ==================================================
        // ALL DAY DOUBLE – TENS
        // GET api/DoubleTensPair/alldaydoubletenspair
        // ==================================================
        [HttpGet("alldaydoubletenspair")]
        public async Task<ActionResult<List<List<Calendar>>>> SearchAllDays(string doubletenspair)
        {
            if (doubletenspair != "doubletenspair")
                return BadRequest("Parameter must be 'doubletenspair'.");

            var foundRows = await _context.Table1
                .Where(c =>
                    DoubleNumbers.Contains(c.Am) &&
                    TensNumbers.Contains(c.Pm))
                .OrderBy(c => c.Id)
                .ToListAsync();
        ...
        // ==================================================
        // WEEK SETS DOUBLE – TENS
        // GET api/DoubleTensPair/weeksetdoubletenspair
        // ==================================================
        [HttpGet("weeksetdoubletenspair")]
        public async Task<ActionResult<List<List<Calendar>>>> SearchWeekSets(
            string doubletenspair, string day)
        {
            if (doubletenspair != "doubletenspair")
                return BadRequest("Parameter must be 'doubletenspair'.");
