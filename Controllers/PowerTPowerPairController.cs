...
namespace TwoDPro3.Controllers
{
    ...
    public class PowerTPowerPairController : Controller
    {
        private readonly CalendarContext _context;

        public PowerTPowerPairController(CalendarContext context)
        {
            _context = context;
        }
        ...
        // ==================================================
        // ALL DAY POWER–T POWER
        // GET api/PowerTPowerPair/alldaypowertpowerpair
        // ==================================================
        [HttpGet("alldaypowertpowerpair")]
        public async Task<ActionResult<List<List<Calendar>>>> SearchAllDays(string powertpowerpair)
        {
            if (powertpowerpair != "powertpowerpair")
                return BadRequest("Parameter must be 'powertpowerpair'.");
        ...
        // ==================================================
        // WEEK SETS POWER–T POWER
        // GET api/PowerTPowerPair/weeksetspowertpowerpair
        // ==================================================
        [HttpGet("weeksetspowertpowerpair")]
        public async Task<ActionResult<List<List<Calendar>>>> SearchWeekSets(
            string powertpowerpair, string day)
        {
            if (powertpowerpair != "powertpowerpair")
                return BadRequest("Parameter must be 'powertpowerpair'.");
