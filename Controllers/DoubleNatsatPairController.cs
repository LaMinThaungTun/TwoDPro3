...
namespace TwoDPro3.Controllers
{
    ...
    public class DoubleNatsatPairController : Controller
    {
        private readonly CalendarContext _context;

        public DoubleNatsatPairController(CalendarContext context)
        {
            _context = context;
        }

        // ==========================
        // DOUBLE & NATSAT NUMBERS
        // ==========================
        ...
        // ==========================================================
        // 1) ALL DAY DOUBLE–NATSAT PAIR
        // GET api/DoubleNatsatPair/alldaydoublenatsatpair?doublenatsatpair=doublenatsatpair
        // ==========================================================
        [HttpGet("alldaydoublenatsatpair")]
        public async Task<ActionResult<List<List<Calendar>>>> SearchAllDays(string doublenatsatpair)
        {
            if (doublenatsatpair != "doublenatsatpair")
            ...
            if (!foundRows.Any())
                return NotFound("No double natsat pairs found.");
        ...
        // ==========================================================
        // 2) WEEK SETS DOUBLE–NATSAT PAIR
        // GET api/DoubleNatsatPair/weeksetsdoublenatsatpair?doublenatsatpair=doublenatsatpair&day=Monday
        // ==========================================================
        [HttpGet("weeksetsdoublenatsatpair")]
        public async Task<ActionResult<List<List<Calendar>>>> SearchWeekSets(string doublenatsatpair, string day)
        {
            if (doublenatsatpair != "doublenatsatpair")
                return BadRequest("Parameter must be 'doublenatsatpair'.");
