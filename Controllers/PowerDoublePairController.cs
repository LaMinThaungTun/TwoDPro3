...
namespace TwoDPro3.Controllers
{
    ...
    public class PowerDoublePairController : Controller
    {
        private readonly CalendarContext _context;

        public PowerDoublePairController(CalendarContext context)
        {
            _context = context;
        }

        // ==========================
        // POWER & DOUBLE NUMBERS
        // ==========================
        ...
        // ==========================================================
        // 1) ALL DAY POWER–DOUBLE PAIR
        // GET api/PowerDoublePair/alldaypowerdoublepair?powerdoublepair=powerdoublepair
        // ==========================================================
        [HttpGet("alldaypowerdoublepair")]
        public async Task<ActionResult<List<List<Calendar>>>> SearchAllDays(string powerdoublepair)
        {
            if (powerdoublepair != "powerdoublepair")
                return BadRequest("Parameter must be 'powerdoublepair'.");
            ...
            if (!foundRows.Any())
                return NotFound("No power double pairs found.");
        ...
        // ==========================================================
        // 2) WEEK SETS POWER–DOUBLE PAIR
        // GET api/PowerDoublePair/weeksetspowerdoublepair?powerdoublepair=powerdoublepair&day=Monday
        // ==========================================================
        [HttpGet("weeksetspowerdoublepair")]
        public async Task<ActionResult<List<List<Calendar>>>> SearchWeekSets(string powerdoublepair, string day)
        {
            if (powerdoublepair != "powerdoublepair")
                return BadRequest("Parameter must be 'powerdoublepair'.");
