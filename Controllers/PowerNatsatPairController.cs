...
namespace TwoDPro3.Controllers
{
    ...
    public class PowerNatsatPairController : Controller
    {
        private readonly CalendarContext _context;

        public PowerNatsatPairController(CalendarContext context)
        {
            _context = context;
        }
        ...
        // ==================================================
        // ALL DAY POWER–NATSAT
        // GET api/PowerNatsatPair/alldaypowernatsatpair
        // ==================================================
        [HttpGet("alldaypowernatsatpair")]
        public async Task<ActionResult<List<List<Calendar>>>> SearchAllDays(string powernatsatpair)
        {
            if (powernatsatpair != "powernatsatpair")
                return BadRequest("Parameter must be 'powernatsatpair'.");
        ...
        // ==================================================
        // WEEK SETS POWER–NATSAT
        // GET api/PowerNatsatPair/weeksetspowernatsatpair
        // ==================================================
        [HttpGet("weeksetspowernatsatpair")]
        public async Task<ActionResult<List<List<Calendar>>>> SearchWeekSets(
            string powernatsatpair, string day)
        {
            if (powernatsatpair != "powernatsatpair")
                return BadRequest("Parameter must be 'powernatsatpair'.");
