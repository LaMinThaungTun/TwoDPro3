...
namespace TwoDPro3.Controllers
{
    ...
    public class PadetharBrotherPairController : Controller
    {
        private readonly CalendarContext _context;

        public PadetharBrotherPairController(CalendarContext context)
        {
            _context = context;
        }
        ...
        // ==================================================
        // ALL DAYS
        // GET api/PadetharBrotherPair/alldaypadetharbrotherpair?padetharbrotherpair=padetharbrotherpair
        // ==================================================
        [HttpGet("alldaypadetharbrotherpair")]
        public async Task<ActionResult<List<List<Calendar>>>> SearchAllDays(string padetharbrotherpair)
        {
            if (padetharbrotherpair != "padetharbrotherpair")
                return BadRequest("Parameter must be 'padetharbrotherpair'.");
            ...
            if (!foundRows.Any())
                return NotFound("No padethar-brother pairs found.");
        ...
        // ==================================================
        // WEEK SETS
        // GET api/PadetharBrotherPair/weeksetspadetharbrotherpair?padetharbrotherpair=padetharbrotherpair&day=Monday
        // ==================================================
        [HttpGet("weeksetspadetharbrotherpair")]
        public async Task<ActionResult<List<List<Calendar>>>> SearchWeekSets(string padetharbrotherpair, string day)
        {
            if (padetharbrotherpair != "padetharbrotherpair")
                return BadRequest("Parameter must be 'padetharbrotherpair'.");
