...
namespace TwoDPro3.Controllers
{
    ...
    public class TPowerTNatsatPairController : Controller
    {
        private readonly CalendarContext _context;

        public TPowerTNatsatPairController(CalendarContext context)
        {
            _context = context;
        }
        ...
        // ==================================================
        // ALL DAY T POWER – T NATSAT
        // GET api/TPowerTNatsatPair/alldaytpowertnatsatpair
        // ==================================================
        [HttpGet("alldaytpowertnatsatpair")]
        public async Task<ActionResult<List<List<Calendar>>>> SearchAllDays(string tpowertnatsatpair)
        {
            if (tpowertnatsatpair != "tpowertnatsatpair")
                return BadRequest("Parameter must be 'tpowertnatsatpair'.");
        ...
        // ==================================================
        // WEEK SETS T POWER – T NATSAT
        // GET api/TPowerTNatsatPair/weeksetstpowertnatsatpair
        // ==================================================
        [HttpGet("weeksetstpowertnatsatpair")]
        public async Task<ActionResult<List<List<Calendar>>>> SearchWeekSets(
            string tpowertnatsatpair, string day)
        {
            if (tpowertnatsatpair != "tpowertnatsatpair")
                return BadRequest("Parameter must be 'tpowertnatsatpair'.");
