...
namespace TwoDPro3.Controllers
{
    ...
    public class PowerPadetharPairController : Controller
    {
        private readonly CalendarContext _context;

        public PowerPadetharPairController(CalendarContext context)
        {
            _context = context;
        }
        ...
        // ==================================================
        // ALL DAYS
        // GET api/PowerPadetharPair/alldaypowerpadetharpair?powerpadetharpair=powerpadetharpair
        // ==================================================
        [HttpGet("alldaypowerpadetharpair")]
        public async Task<ActionResult<List<List<Calendar>>>> SearchAllDays(string powerpadetharpair)
        {
            if (powerpadetharpair != "powerpadetharpair")
                return BadRequest("Parameter must be 'powerpadetharpair'.");
            ...
            if (!foundRows.Any())
                return NotFound("No power-padethar pairs found.");
        ...
        // ==================================================
        // WEEK SETS
        // GET api/PowerPadetharPair/weeksetspowerpadetharpair?powerpadetharpair=powerpadetharpair&day=Monday
        // ==================================================
        [HttpGet("weeksetspowerpadetharpair")]
        public async Task<ActionResult<List<List<Calendar>>>> SearchWeekSets(string powerpadetharpair, string day)
        {
            if (powerpadetharpair != "powerpadetharpair")
                return BadRequest("Parameter must be 'powerpadetharpair'.");
