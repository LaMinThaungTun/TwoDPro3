...
namespace TwoDPro3.Controllers
{
    ...
    public class NatsatPowerPairController : Controller
    {
        private readonly CalendarContext _context;

        public NatsatPowerPairController(CalendarContext context)
        {
            _context = context;
        }
        ...
        // ==================================================
        // ALL DAY NATSAT–POWER
        // GET api/NatsatPowerPair/alldaynatsatpowerpair
        // ==================================================
        [HttpGet("alldaynatsatpowerpair")]
        public async Task<ActionResult<List<List<Calendar>>>> SearchAllDays(string natsatpowerpair)
        {
            if (natsatpowerpair != "natsatpowerpair")
                return BadRequest("Parameter must be 'natsatpowerpair'.");
        ...
        // ==================================================
        // WEEK SETS NATSAT–POWER
        // GET api/NatsatPowerPair/weeksetsnatsatpowerpair
        // ==================================================
        [HttpGet("weeksetsnatsatpowerpair")]
        public async Task<ActionResult<List<List<Calendar>>>> SearchWeekSets(
            string natsatpowerpair, string day)
        {
            if (natsatpowerpair != "natsatpowerpair")
                return BadRequest("Parameter must be 'natsatpowerpair'.");
