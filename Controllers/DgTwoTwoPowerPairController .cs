...
namespace TwoDPro3.Controllers
{
    ...
    public class DgTwoTwoPowerPairController : Controller
    {
        private readonly CalendarContext _context;

        public DgTwoTwoPowerPairController(CalendarContext context)
        {
            _context = context;
        }
        ...
        // ================= ALL DAYS =================
        [HttpGet("alldaydgtwotwopowerpair")]
        public async Task<ActionResult<List<List<Calendar>>>> SearchAllDays(string dgtwotwopowerpair)
        {
            if (dgtwotwopowerpair != "dgtwotwopowerpair")
                return BadRequest("Parameter must be 'dgtwotwopowerpair'.");
            ...
            var foundRows = await _context.Table1
                .Where(c =>
                    ...
                    (
                        (c.AmDgTwo == "0" && c.PmDgTwo == "5") || (c.AmDgTwo == "5" && c.PmDgTwo == "0") ||
                        (c.AmDgTwo == "1" && c.PmDgTwo == "6") || (c.AmDgTwo == "6" && c.PmDgTwo == "1") ||
                        (c.AmDgTwo == "2" && c.PmDgTwo == "7") || (c.AmDgTwo == "7" && c.PmDgTwo == "2") ||
                        (c.AmDgTwo == "3" && c.PmDgTwo == "8") || (c.AmDgTwo == "8" && c.PmDgTwo == "3") ||
                        (c.AmDgTwo == "4" && c.PmDgTwo == "9") || (c.AmDgTwo == "9" && c.PmDgTwo == "4")
                    )
            ...
            if (!foundRows.Any())
                return NotFound("No matching DG Two-Two power pairs found.");
        ...
        // ================= WEEK SETS =================
        [HttpGet("weeksetsdgtwotwopowerpair")]
        public async Task<ActionResult<List<List<Calendar>>>> SearchWeekSets(string dgtwotwopowerpair, string day)
        {
            if (dgtwotwopowerpair != "dgtwotwopowerpair")
                return BadRequest("Parameter must be 'dgtwotwopowerpair'.");
