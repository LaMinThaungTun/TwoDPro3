...
namespace TwoDPro3.Controllers
{
    ...
    public class BrotherTNatsatPairController : Controller
    {
        private readonly CalendarContext _context;

        public BrotherTNatsatPairController(CalendarContext context)
        {
            _context = context;
        }
        ...
        // ==================================================
        // ALL DAY BROTHER–TNATSAT
        // GET api/BrotherTNatsatPair/alldaybrothertnatsatpair
        // ==================================================
        [HttpGet("alldaybrothertnatsatpair")]
        public async Task<ActionResult<List<List<Calendar>>>> SearchAllDays(string brothertnatsatpair)
        {
            if (brothertnatsatpair != "brothertnatsatpair")
                return BadRequest("Parameter must be 'brothertnatsatpair'.");
        ...
        // ==================================================
        // WEEK SETS BROTHER–TNATSAT
        // GET api/BrotherTNatsatPair/weeksetsbrothertnatsatpair
        // ==================================================
        [HttpGet("weeksetsbrothertnatsatpair")]
        public async Task<ActionResult<List<List<Calendar>>>> SearchWeekSets(
            string brothertnatsatpair, string day)
        {
            if (brothertnatsatpair != "brothertnatsatpair")
                return BadRequest("Parameter must be 'brothertnatsatpair'.");
