...
namespace TwoDPro3.Controllers
{
    ...
    public class DgTwoOneSamePairController : Controller
    {
        private readonly CalendarContext _context;

        public DgTwoOneSamePairController(CalendarContext context)
        {
            _context = context;
        }
        ...
        // ==========================================================
        // 1) ALL DAYS SEARCH
        // GET api/DgTwoOneSamePair/alldaydgtwoonesamepair?dgtwoonesamepair=dgtwoonesamepair
        // ==========================================================
        [HttpGet("alldaydgtwoonesamepair")]
        public async Task<ActionResult<List<List<Calendar>>>> SearchAllDays(
            string dgtwoonesamepair)
        {
            var foundRows = await _context.Table1
                .Where(c =>
                    c.AmDgTwo == c.PmDgOne &&
                    c.AmDgTwo != "aa")   // 🚫 skip "aa"
                .OrderBy(c => c.Id)
                .ToListAsync();

            if (!foundRows.Any())
                return NotFound("No matching DG Two–One SAME pair found.");
        ...
        // ==========================================================
        // 2) WEEKSETS SEARCH
        // GET api/DgTwoOneSamePair/weeksetsdgtwoonesamepair?dgtwoonesamepair=dgtwoonesamepair&day=Monday
        // ==========================================================
