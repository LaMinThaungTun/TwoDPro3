...
namespace TwoDPro3.Controllers
{
    ...
    public class NatsatTPowerPairController : Controller
    {
        private readonly CalendarContext _context;

        public NatsatTPowerPairController(CalendarContext context)
        {
            _context = context;
        }
        ...
        // ==================================================
        // ALL DAY NATSAT – T POWER
        // GET api/NatsatTPowerPair/alldaynatsattpowerpair
        // ==================================================
        [HttpGet("alldaynatsattpowerpair")]
        public async Task<ActionResult<List<List<Calendar>>>> SearchAllDays(string natsattpowerpair)
        {
            if (natsattpowerpair != "natsattpowerpair")
                return BadRequest("Parameter must be 'natsattpowerpair'.");
        ...
        // ==================================================
        // WEEK SETS NATSAT – T POWER
        // GET api/NatsatTPowerPair/weeksetsnatsattpowerpair
        // ==================================================
        [HttpGet("weeksetsnatsattpowerpair")]
        public async Task<ActionResult<List<List<Calendar>>>> SearchWeekSets(
            string natsattpowerpair, string day)
        {
            if (natsattpowerpair != "natsattpowerpair")
                return BadRequest("Parameter must be 'natsattpowerpair'.");
