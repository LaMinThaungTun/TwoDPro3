...
namespace TwoDPro3.Controllers
{
    ...
    public class DoublePadetharPairController : Controller
    {
        private readonly CalendarContext _context;

        public DoublePadetharPairController(CalendarContext context)
        {
            _context = context;
        }
        ...
        // ==================================================
        // ALL DAYS
        // GET api/DoublePadetharPair/alldaydoublepadetharpair?doublepadetharpair=doublepadetharpair
        // ==================================================
        [HttpGet("alldaydoublepadetharpair")]
        public async Task<ActionResult<List<List<Calendar>>>> SearchAllDays(string doublepadetharpair)
        {
            if (doublepadetharpair != "doublepadetharpair")
                return BadRequest("Parameter must be 'doublepadetharpair'.");
            ...
            if (!foundRows.Any())
                return NotFound("No double-padethar pairs found.");
        ...
        // ==================================================
        // WEEK SETS
        // GET api/DoublePadetharPair/weeksetsdoublepadetharpair?doublepadetharpair=doublepadetharpair&day=Monday
        // ==================================================
        [HttpGet("weeksetsdoublepadetharpair")]
        public async Task<ActionResult<List<List<Calendar>>>> SearchWeekSets(string doublepadetharpair, string day)
        {
            if (doublepadetharpair != "doublepadetharpair")
                return BadRequest("Parameter must be 'doublepadetharpair'.");
